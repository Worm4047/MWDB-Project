...
from src.common.latentSemanticsSaver import getParams, getSemanticsFromFolder
from sklearn import svm
from src.archive.dimRedHelper import getQueryImageRepList, getQueryImageRep
